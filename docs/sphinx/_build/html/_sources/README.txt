...
- replace any dragonfly Grammar_ class with :py:class:`~_grammars.GlobalRegistry`,
- replace any dragonfly CompoundRule_ with :py:class:`~_rules.FluidRule`,
- replace any dragonfly MappingRule_ with :py:class:`~_rules.QuickFluidRules`,
- reload your macros!
